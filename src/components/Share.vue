<template>
  <div id="share">
    <div id="social" class="share-container">
      DELI!
      <a :href="`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(currentUrl)}`" class="social-button fb"></a>
      <a :href="`http://twitter.com/share?text=text goes here&url=${encodeURIComponent(currentUrl)}&hashtags=soocenje`" class="social-button tw"></a>
      <a :href="`mailto:?Subject=Ha%20ha%20ha&body=${encodeURIComponent(currentUrl)}`" class="social-button mail"></a>
    </div>
